            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <form action="{{ route('products.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="sku" name="sku" value="{{ old('sku') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('sku') border-red-500 @enderror" required>
                        @error('sku')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
